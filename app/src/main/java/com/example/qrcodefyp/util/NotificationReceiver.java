package com.example.qrcodefyp.util;
...
import com.example.qrcodefyp.activity.MyReceiptActivity;
...
public class NotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ID != 0) {
            Intent notificationIntent = new Intent(context, MyReceiptActivity.class);
